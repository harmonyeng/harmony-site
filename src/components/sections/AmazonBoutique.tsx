      ...
      {product ? (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="font-serif text-[13.5px] font-normal text-ink leading-[1.4] mb-1.5">{product.name}</div>
            <div className="font-serif text-[12px] italic text-muted leading-[1.55] mb-1.5 line-clamp-2">{product.snippet}</div>
            <div className="font-mono text-[8px] tracking-[0.15em] text-gold uppercase">View on Amazon →</div>
          </div>
        </a>
      ) : (
        <p className="font-serif text-[13px] italic text-muted opacity-60">First product coming soon.</p>
      )}
    </div>
  )
}
